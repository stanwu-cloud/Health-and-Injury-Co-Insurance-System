...
- **第二階段（`feature/phase-two`，進行中）**：新增第三張報表「**當月賠款月帳單－T字帳**」——只讀理賠檔，**排除簽單年度 == 設定年**，其餘每個簽單年度各產出一份。**P-01 ~ P-07 已由業務方回覆結案（4 項阻斷全解），M2 起可動工**；P-08 ~ P-11 未回覆、暫依建議推進。定案規則見 `..._LOG_第二階段問題追蹤清單.md` §5。
